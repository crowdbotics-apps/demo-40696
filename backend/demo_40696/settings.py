"""
Django settings for demo_40696 project.
...
WSGI_APPLICATION = 'demo_40696.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "demo_40696 API",
    "DESCRIPTION": "API documentation for demo_40696 App",
    "VERSION": "v1",
}
